            ...
            : <div>
                <Grid container alignItems="center" justify="center" direction="row" className="ad-details">
                    ...
                    <Grid item xs={12} sm={6} lg={4} className="info">
                        ...
                        {localStorage.getItem('jwt') && localStorage.getItem('email') !== props.ad.email &&
                            <div>
                                <TextField
                                    id="outlined-dense"
                                    className="bid"
                                ...
                                {!localStorage.getItem('offerMade')
                                    ? <Button variant="contained" size="medium" color="secondary" className="bid-btn" onClick={props.handleMakeOfferSubmit}>
                                        Make offer
                                    </Button>

                                    : <Button variant="contained" size="medium" color="secondary" disabled className="bid-btn" onClick={props.handleMakeOfferSubmit}>
                                        Make offer
                                    </Button>}

                                {localStorage.getItem('offerMade') &&
                                    <p><i>You made an offer to the seller!</i></p>}
                            </div>
                        }
